    ...
    <div className="bg-[#f4e6d5] text-gray-800">
      ...
      <header className="bg-[#4b2e2e] text-[#f8d7a3] py-4 px-8 flex justify-between items-center">
        ...
        <nav className="space-x-6 hidden md:block">
          ...
          <a href="#" className="hover:text-white">Wholesale Inquiry</a>
      ...
      <section className="bg-[#6d3f2b] text-white px-8 py-16 flex flex-col md:flex-row items-center justify-between">
        <div className="max-w-xl">
          ...
          <h3 className="text-2xl text-[#f8d7a3] mb-4">Wholesale Supplier</h3>
          <p className="mb-6">Quality Agarbatti at Best Prices!</p>
        ...
        <div className="mt-10 md:mt-0">
          <div className="w-80 h-60 bg-white rounded shadow-md"></div>
        </div>
      </section>
